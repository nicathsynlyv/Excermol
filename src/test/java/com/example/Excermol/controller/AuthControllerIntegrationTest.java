...
class AuthControllerIntegrationTest extends AbstractIntegrationTest {
    ...
    void refresh_withValidRefreshToken_shouldReturnNewAccessToken() {
        ...
        System.out.println("Status: " + refreshResponse.getStatusCode());
    ...
    void logout_shouldRevokeTokenAndClearCookies() {
        ...
        System.out.println("Status: " + logoutResponse.getStatusCode());
        ...
        System.out.println("Status: " + retryResponse.getStatusCode());
